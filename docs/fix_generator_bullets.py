...
# Helper to generate the bullet-pointing code for a block of text
def make_bullet_code(var_names):
    code_blocks = []
    for var in var_names:
        code_blocks.append(f"""    for sentence in {var}.split('.'):
...
{make_bullet_code(['text1', 'text2', 'text3'])}
...
print("Fixed generate_pdf.py prelim pages with correct bullet point formatting.")
