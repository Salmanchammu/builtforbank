...
(function () {
    window.SmartBankDeviceDetector = {
        ...
        reverseMap: {
            ...
            'mobile-forgot-password.html': 'mobile-forgot-password.html', // Fixed: don't force desktop
            // removed mobile-dash.html -> userdash.html to prevent incorrect role redirects
        },
        ...
        // Helper to get the correct dashboard based on device and optional role
        getDashboardUrl: function(role) {
            const device = this.getDeviceType();
            if (device === 'mobile' || device === 'tablet') {
                return 'mobile-dash.html';
            }
            
            // Desktop role-based redirection
            if (role === 'staff') return 'staffdash.html';
            if (role === 'admin') return 'admindash.html';
