...
window.fetch = async function (url, options) {
    ...
    try {
        ...
        if (response.status === 401 && isInternalAPI && !url.includes('/auth/') && !url.includes('face-login') && !url.includes('attendance')) {
            ...
            const publicPages = ['user.html', 'signup.html', 'forgot-password.html', 'mobile-auth.html', 'mobile-signin.html', 'mobile-forgot-password.html', 'index.html', 'reset-password.html', 'staff.html'];
